  ...
  return `
    <div class="auth-mobile-container">
      ...
      <div style="margin-top: 2rem; text-align: center;">
        <button type="button" id="pwaInstallBtn" class="btn-primary" style="display: inline-block; padding: 0.75rem 1.5rem; font-size: 0.9rem; border-radius: 8px; border: none; font-weight: 700; box-shadow: 0 4px 15px rgba(0, 240, 255, 0.2); width: 100%;">
          📥 Install GoodPay App
        </button>
      </div>
  ...
  if (pwaInstallBtn) {
    pwaInstallBtn.addEventListener('click', async () => {
      if (window.deferredPrompt) {
        ...
        // Fallback for iOS or already installed apps
